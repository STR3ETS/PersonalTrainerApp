    ...
    <body class="bg-[var(--primary-color)]/10">
        <div class="w-full h-screen flex">
            <div class="p-3 bg-white w-fit h-full flex flex-col justify-center gap-2 relative">
                ...
                <a href="#" class="relative w-8 h-8 flex items-center justify-center transition duration-300 rounded-[var(--border-radius)] hover:bg-[var(--primary-color)]/30 group">
                    <i class="fa-solid fa-house text-[var(--text-color)] group-hover:text-[var(--primary-color)] transition duration-300"></i>
                    <span class="absolute left-full ml-2 px-2 py-1 text-xs rounded-[var(--border-radius)] bg-white border border-[#d1d1d1] text-[var(--text-color)] opacity-0 group-hover:opacity-100 transition duration-300 whitespace-nowrap">
                        Overzicht
                    </span>
                </a>
                <a href="#" class="relative w-8 h-8 flex items-center justify-center transition duration-300 rounded-[var(--border-radius)] hover:bg-[var(--primary-color)]/30 group">
                    <i class="fa-solid fa-clipboard-user text-[var(--text-color)] group-hover:text-[var(--primary-color)] transition duration-300"></i>
                    <span class="absolute left-full ml-2 px-2 py-1 text-xs rounded-[var(--border-radius)] bg-white border border-[#d1d1d1] text-[var(--text-color)] opacity-0 group-hover:opacity-100 transition duration-300 whitespace-nowrap">
                        Weekplanning
                    </span>
                </a>
                <a href="#" class="relative w-8 h-8 flex items-center justify-center transition duration-300 rounded-[var(--border-radius)] hover:bg-[var(--primary-color)]/30 group">
                    <i class="fa-solid fa-avocado text-[var(--text-color)] group-hover:text-[var(--primary-color)] transition duration-300"></i>
                    <span class="absolute left-full ml-2 px-2 py-1 text-xs rounded-[var(--border-radius)] bg-white border border-[#d1d1d1] text-[var(--text-color)] opacity-0 group-hover:opacity-100 transition duration-300 whitespace-nowrap">
                        Voeding
                    </span>
                </a>
                <a href="#" class="relative w-8 h-8 flex items-center justify-center transition duration-300 rounded-[var(--border-radius)] hover:bg-[var(--primary-color)]/30 group">
                    <i class="fa-solid fa-video text-[var(--text-color)] group-hover:text-[var(--primary-color)] transition duration-300"></i>
                    <span class="absolute left-full ml-2 px-2 py-1 text-xs rounded-[var(--border-radius)] bg-white border border-[#d1d1d1] text-[var(--text-color)] opacity-0 group-hover:opacity-100 transition duration-300 whitespace-nowrap">
                        Trainingsvideos
                    </span>
                </a>
                <a href="https://www.2befitsupplements.nl" target="_blank" class="relative w-8 h-8 flex items-center justify-center transition duration-300 rounded-[var(--border-radius)] hover:bg-[var(--primary-color)]/30 group">
                    <i class="fa-solid fa-shopping-bag text-[var(--text-color)] group-hover:text-[var(--primary-color)] transition duration-300"></i>
                    <span class="absolute left-full ml-2 px-2 py-1 text-xs rounded-[var(--border-radius)] bg-white border border-[#d1d1d1] text-[var(--text-color)] opacity-0 group-hover:opacity-100 transition duration-300 whitespace-nowrap">
                        Supplementen
                    </span>
                </a>
            ...
            <div class="flex-1 overflow-y-auto">
                <div class="w-full h-auto p-2 bg-[var(--primary-color)] flex items-center justify-end gap-4 sticky top-0 z-999">
                    <form method="POST" action="{{ route('logout') }}" class="relative group">
                        @csrf
                        <button type="submit" class="w-8 h-8 bg-white/40 hover:bg-white/60 transition duration-300 cursor-pointer rounded-full flex items-center justify-center text-sm font-medium text-[var(--primary-color)] leading-tighter">
                            <i class="fa-solid fa-right-from-bracket text-[var(--primary-color)] transition duration-300"></i>
                        </button>
                    </form>
                </div>
                                ...
                                <div class="w-full bg-white rounded-[var(--border-radius)] p-[1.5rem]">
                                    ...
                                    <div class="grid grid-cols-1">
                                        <p class=" flex items-center justify-between">
                                            ...
                                            <span class="text-sm tracking-tighter leading-tight text-[var(--text-color)]">
                                                {{ $tdee }} kcal
                                            </span>
                                        </p>
                                        ...
                                        <p class="mt-8 md:mt-[4.563rem] text-xs text-[var(--text-color)]/50 tracking-tighter font-medium">
                                            Deze berekening is gebaseerd op jouw leeftijd, gewicht en trainingsschema.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="fade-in-up flex flex-col gap-4">
                                ...
                                <div id="chatbot" class="w-full bg-white rounded-[var(--border-radius)] p-[1.5rem] flex flex-col gap-4">
                                    ...
                                    <div class="flex gap-2">
                                        <input id="chat-input" type="text" class="w-full outline-none border border-[#d1d1d1] focus:border-[var(--primary-color)] transition duration-300 p-2.5 rounded-[var(--border-radius)] text-sm bg-white text-[var(--text-color)]" placeholder="Stel jouw vraag...">
                                        <button id="chat-send" class="text-white font-semibold text-sm bg-[var(--primary-color)] hover:bg-[var(--primary-color)]/80 transition duration-300 cursor-pointer py-2.5 px-4 rounded-[var(--border-radius)] flex items-center whitespace-nowrap">Verstuur</button>
                                    </div>
                                </div>
                            </div>
                        </div>
